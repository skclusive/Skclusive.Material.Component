...
{
    public partial class InputBase : FormConfigContext
    {
        public InputBase() : base("InputBase")
        {
        }
        ...
        protected string _AutoCorrect => AutoCorrect ? "on" : "off";

        protected string _AutoCapitalize => AutoCapitalize ? "on" : "off";
