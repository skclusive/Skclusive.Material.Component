# Skclusive.Material.Component Contributor Guide

Welcome to a community of developers just like you, striving to create the best experience around Skclusive.Material.Component. We welcome anyone who wants to contribute or provide constructive feedback, no matter the age or level of experience.
...
Include in the issue a link to your reproduction. A good option is a small Github repo.
...
In addition to reporting issues, a great way to contribute to Skclusive.Material.Component is to respond to other peoples' issues and try to identify the problem or help them work around it. If you’re interested in taking a more active role in this process, please go ahead and respond to issues.
